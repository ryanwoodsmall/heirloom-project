...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/grap.sl	5.5 (gritter) 12/5/05";
const char version[] = "version Dec 30, 1995	5.5 (gritter) 12/5/05";
/* SLIST */
/*
...
input.c:	Sccsid @(#)input.c	1.5 (gritter) 12/5/05	
