...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/grap.sl	5.2 (gritter) 11/5/05";
const char version[] = "version Dec 30, 1995	5.2 (gritter) 11/5/05";
/* SLIST */
/*
...
grapl.c:	Sccsid @(#)grapl.l	1.3 (gritter) 10/18/05	
