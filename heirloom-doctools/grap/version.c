...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/grap.sl	5.6 (gritter) 1/19/06";
const char version[] = "version Dec 30, 1995	5.6 (gritter) 1/19/06";
/* SLIST */
/*
...
input.c:	Sccsid @(#)input.c	1.6 (gritter) 1/19/06	
