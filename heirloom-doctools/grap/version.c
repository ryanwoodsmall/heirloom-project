...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/grap.sl	5.3 (gritter) 11/22/05";
const char version[] = "version Dec 30, 1995	5.3 (gritter) 11/22/05";
/* SLIST */
/*
...
grap.h:	Sccsid @(#)grap.h	1.4 (gritter) 10/25/05	
grap.y:	Sccsid @(#)grap.y	1.3 (gritter) 10/18/05	
grapl.c:	Sccsid @(#)version.c	5.3 (gritter) 11/22/05	
grapl.l:	Sccsid @(#)grapl.l	1.4 (gritter) 11/22/05	
input.c:	Sccsid @(#)input.c	1.4 (gritter) 10/19/05	
label.c:	Sccsid @(#)label.c	1.2 (gritter) 10/18/05	
main.c:	Sccsid @(#)main.c	1.4 (gritter) 11/5/05	
