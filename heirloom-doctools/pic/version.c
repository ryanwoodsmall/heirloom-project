...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/pic.sl	1.4 (gritter) 10/18/05";
const char version[] = "version July 5, 1993	1.4 (gritter) 10/18/05";
/* SLIST */
/*
...
input.c:	Sccsid @(#)input.c	1.4 (gritter) 10/18/05	
...
picl.c:	Sccsid @(#)picl.l	1.3 (gritter) 10/18/05	
