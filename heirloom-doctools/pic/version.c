...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/pic.sl	5.9 (gritter) 8/6/06";
const char version[] = "version July 5, 1993	5.9 (gritter) 8/6/06";
/* SLIST */
/*
...
picl.c:	Sccsid @(#)version.c	5.9 (gritter) 8/6/06	
