...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/pic.sl	5.2 (gritter) 11/22/05";
const char version[] = "version July 5, 1993	5.2 (gritter) 11/22/05";
/* SLIST */
/*
...
picl.c:	Sccsid @(#)version.c	5.2 (gritter) 11/22/05	
picl.l:	Sccsid @(#)picl.l	1.6 (gritter) 11/22/05	
