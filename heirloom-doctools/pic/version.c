...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/pic.sl	5.3 (gritter) 11/27/05";
const char version[] = "version July 5, 1993	5.3 (gritter) 11/27/05";
/* SLIST */
/*
...
picl.c:	Sccsid @(#)version.c	5.3 (gritter) 11/27/05	
