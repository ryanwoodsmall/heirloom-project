...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/pic.sl	5.5 (gritter) 12/5/05";
const char version[] = "version July 5, 1993	5.5 (gritter) 12/5/05";
/* SLIST */
/*
...
input.c:	Sccsid @(#)input.c	1.6 (gritter) 12/5/05	
