...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/pic.sl	5.4 (gritter) 11/28/05";
const char version[] = "version July 5, 1993	5.4 (gritter) 11/28/05";
/* SLIST */
/*
...
picl.c:	Sccsid @(#)picl.l	1.7 (gritter) 11/27/05	
picl.c: * Sccsid @(#)ncform	1.4 (gritter) 11/18/05
picl.l:	Sccsid @(#)picl.l	1.7 (gritter) 11/27/05	
picy.c:	Sccsid @(#)version.c	5.4 (gritter) 11/28/05	
