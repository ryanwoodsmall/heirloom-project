...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.8 (gritter) 9/19/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.8 (gritter) 9/19/05";
/* SLIST */
/*
...
../afm.c: * Sccsid @(#)afm.c	1.29 (gritter) 9/18/05
