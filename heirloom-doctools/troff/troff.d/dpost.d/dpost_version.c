...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.18 (gritter) 8/18/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.18 (gritter) 8/18/05";
/* SLIST */
/*
...
dpost_afm.c: * Sccsid @(#)afm.c	1.7 (gritter) 8/18/05
