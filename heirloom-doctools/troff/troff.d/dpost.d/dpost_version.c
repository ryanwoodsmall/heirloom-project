...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.6 (gritter) 9/18/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.6 (gritter) 9/18/05";
/* SLIST */
/*
...
../afm.c: * Sccsid @(#)afm.c	1.28 (gritter) 9/18/05
