...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.35 (gritter) 10/3/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.35 (gritter) 10/3/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.98 (gritter) 10/3/05
