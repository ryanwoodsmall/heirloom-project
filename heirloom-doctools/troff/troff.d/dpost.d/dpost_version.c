...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.85 (gritter) 9/9/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.85 (gritter) 9/9/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.71 (gritter) 9/9/05
