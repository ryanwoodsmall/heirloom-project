...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.49 (gritter) 8/27/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.49 (gritter) 8/27/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.40 (gritter) 8/27/05
