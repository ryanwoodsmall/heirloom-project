...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.34 (gritter) 8/21/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.34 (gritter) 8/21/05";
/* SLIST */
/*
...
../afm.c: * Sccsid @(#)afm.c	1.9 (gritter) 8/19/05
