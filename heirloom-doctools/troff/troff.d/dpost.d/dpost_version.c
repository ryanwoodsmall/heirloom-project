...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.9 (gritter) 9/20/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.9 (gritter) 9/20/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.82 (gritter) 9/19/05
