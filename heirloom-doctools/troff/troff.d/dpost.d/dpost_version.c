...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.12 (gritter) 9/25/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.12 (gritter) 9/25/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.85 (gritter) 9/25/05
