...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.50 (gritter) 8/28/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.50 (gritter) 8/28/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.41 (gritter) 8/28/05
