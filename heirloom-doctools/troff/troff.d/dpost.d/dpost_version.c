...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.19 (gritter) 9/28/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.19 (gritter) 9/28/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.91 (gritter) 9/28/05
