...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.16 (gritter) 8/18/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.16 (gritter) 8/18/05";
/* SLIST */
/*
...
dpost_afm.c: * Sccsid @(#)afm.c	1.6 (gritter) 8/18/05
