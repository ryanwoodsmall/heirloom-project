...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.11 (gritter) 9/22/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.11 (gritter) 9/22/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.84 (gritter) 9/22/05
