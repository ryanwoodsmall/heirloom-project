...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.41 (gritter) 8/23/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.41 (gritter) 8/23/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.34 (gritter) 8/23/05
