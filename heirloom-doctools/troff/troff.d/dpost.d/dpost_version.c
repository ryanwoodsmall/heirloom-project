...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.18 (gritter) 9/28/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.18 (gritter) 9/28/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.90 (gritter) 9/27/05
dpost.h: * Sccsid @(#)dpost.h	1.5 (gritter) 9/20/05
...
dpost_otf.c: * Sccsid @(#)dpost_otf.c	1.1 (gritter) 9/27/05
...
../afm.c: * Sccsid @(#)afm.c	1.32 (gritter) 9/28/05
../afm.h: * Sccsid @(#)afm.h	1.12 (gritter) 9/27/05
../otf.c: * Sccsid @(#)otf.c	1.2 (gritter) 9/28/05
