...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.52 (gritter) 8/30/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.52 (gritter) 8/30/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.43 (gritter) 8/30/05
