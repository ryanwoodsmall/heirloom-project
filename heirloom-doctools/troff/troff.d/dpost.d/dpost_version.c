...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.23 (gritter) 8/19/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.23 (gritter) 8/19/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.19 (gritter) 8/19/05
