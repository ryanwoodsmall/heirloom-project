...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.36 (gritter) 10/3/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.36 (gritter) 10/3/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.99 (gritter) 10/3/05
...
misc.c: * Sccsid @(#)misc.c	1.7 (gritter) 10/2/05
...
../afm.c: * Sccsid @(#)afm.c	1.37 (gritter) 10/2/05
../afm.h: * Sccsid @(#)afm.h	1.16 (gritter) 10/2/05
../otf.c: * Sccsid @(#)otf.c	1.21 (gritter) 10/3/05
