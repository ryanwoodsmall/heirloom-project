...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.92 (gritter) 9/10/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.92 (gritter) 9/10/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.78 (gritter) 9/10/05
...
../afm.c: * Sccsid @(#)afm.c	1.22 (gritter) 9/8/05
