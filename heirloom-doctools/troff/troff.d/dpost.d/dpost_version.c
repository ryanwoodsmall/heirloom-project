...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.55 (gritter) 9/3/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.55 (gritter) 9/3/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.46 (gritter) 9/3/05
