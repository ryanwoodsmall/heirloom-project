...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.46 (gritter) 8/27/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.46 (gritter) 8/27/05";
/* SLIST */
/*
...
../afm.c: * Sccsid @(#)afm.c	1.18 (gritter) 8/27/05
