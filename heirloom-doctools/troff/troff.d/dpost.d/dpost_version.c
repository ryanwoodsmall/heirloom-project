...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.54 (gritter) 9/2/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.54 (gritter) 9/2/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.45 (gritter) 9/2/05
