...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.34 (gritter) 10/3/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.34 (gritter) 10/3/05";
/* SLIST */
/*
...
../otf.c: * Sccsid @(#)otf.c	1.20 (gritter) 10/3/05
