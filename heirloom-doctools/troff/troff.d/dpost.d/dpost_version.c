...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.11 (gritter) 8/16/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.11 (gritter) 8/16/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.9 (gritter) 8/16/05
