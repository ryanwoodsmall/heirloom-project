...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.44 (gritter) 8/25/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.44 (gritter) 8/25/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.37 (gritter) 8/25/05
