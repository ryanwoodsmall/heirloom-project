...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.36 (gritter) 8/22/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.36 (gritter) 8/22/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost_version.c	1.36 (gritter) 8/22/05
...
gen.h: * Sccsid @(#)gen.h	1.6 (gritter) 8/21/05
...
../afm.c: * Sccsid @(#)afm.c	1.11 (gritter) 8/22/05
../afm.h: * Sccsid @(#)afm.h	1.5 (gritter) 8/22/05
*/
