...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.32 (gritter) 8/20/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.32 (gritter) 8/20/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.27 (gritter) 8/20/05
