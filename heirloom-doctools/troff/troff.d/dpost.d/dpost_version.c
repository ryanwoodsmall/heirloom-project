...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.20 (gritter) 8/19/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.20 (gritter) 8/19/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.16 (gritter) 8/19/05
dpost.h: * Sccsid @(#)dpost.h	1.3 (gritter) 8/9/05
dpost_afm.c: * Sccsid @(#)afm.c	1.9 (gritter) 8/19/05
