...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.20 (gritter) 9/29/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.20 (gritter) 9/29/05";
/* SLIST */
/*
...
../afm.c: * Sccsid @(#)afm.c	1.33 (gritter) 9/29/05
../afm.h: * Sccsid @(#)afm.h	1.13 (gritter) 9/29/05
../otf.c: * Sccsid @(#)otf.c	1.4 (gritter) 9/29/05
