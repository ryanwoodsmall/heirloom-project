...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.12 (gritter) 8/17/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.12 (gritter) 8/17/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.10 (gritter) 8/17/05
dpost.h: * Sccsid @(#)dpost.h	1.3 (gritter) 8/9/05
dpost_afm.c: * Sccsid @(#)dpost_version.c	1.12 (gritter) 8/17/05
