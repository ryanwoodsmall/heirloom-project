...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.14 (gritter) 9/25/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.14 (gritter) 9/25/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.87 (gritter) 9/25/05
