...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.21 (gritter) 9/30/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.21 (gritter) 9/30/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.92 (gritter) 9/30/05
...
../otf.c: * Sccsid @(#)otf.c	1.9 (gritter) 9/30/05
