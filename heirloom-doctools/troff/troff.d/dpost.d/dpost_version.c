...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.13 (gritter) 8/17/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.13 (gritter) 8/17/05";
/* SLIST */
/*
...
dpost_afm.c: * Sccsid @(#)afm.c	1.3 (gritter) 8/17/05
