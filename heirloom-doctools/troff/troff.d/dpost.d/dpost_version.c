...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.15 (gritter) 9/25/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.15 (gritter) 9/25/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.88 (gritter) 9/25/05
...
../afm.c: * Sccsid @(#)afm.c	1.30 (gritter) 9/20/05
../afm.h: * Sccsid @(#)afm.h	1.11 (gritter) 9/20/05
