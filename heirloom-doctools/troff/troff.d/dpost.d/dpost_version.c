...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.5 (gritter) 9/18/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.5 (gritter) 9/18/05";
/* SLIST */
/*
...
../afm.c: * Sccsid @(#)afm.c	1.27 (gritter) 9/18/05
