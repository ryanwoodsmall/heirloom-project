...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.81 (gritter) 9/9/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.81 (gritter) 9/9/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.68 (gritter) 9/9/05
