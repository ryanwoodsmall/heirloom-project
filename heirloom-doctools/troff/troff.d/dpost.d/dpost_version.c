...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.45 (gritter) 8/26/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.45 (gritter) 8/26/05";
/* SLIST */
/*
...
../afm.c: * Sccsid @(#)afm.c	1.17 (gritter) 8/26/05
