...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.17 (gritter) 8/18/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.17 (gritter) 8/18/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.14 (gritter) 8/18/05
