...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.14 (gritter) 8/17/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.14 (gritter) 8/17/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.12 (gritter) 8/17/05
