...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.91 (gritter) 9/10/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.91 (gritter) 9/10/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.77 (gritter) 9/10/05
