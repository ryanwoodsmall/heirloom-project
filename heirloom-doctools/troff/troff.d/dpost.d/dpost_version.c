...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.48 (gritter) 8/27/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.48 (gritter) 8/27/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.39 (gritter) 8/27/05
