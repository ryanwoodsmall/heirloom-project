...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.30 (gritter) 10/2/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.30 (gritter) 10/2/05";
/* SLIST */
/*
...
../otf.c: * Sccsid @(#)otf.c	1.17 (gritter) 10/2/05
