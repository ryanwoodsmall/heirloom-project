...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.93 (gritter) 9/11/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.93 (gritter) 9/11/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.79 (gritter) 9/11/05
