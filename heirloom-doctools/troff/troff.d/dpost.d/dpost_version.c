...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.51 (gritter) 8/29/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.51 (gritter) 8/29/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.42 (gritter) 8/29/05
