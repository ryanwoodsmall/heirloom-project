...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.75 (gritter) 9/8/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.75 (gritter) 9/8/05";
/* SLIST */
/*
color.c: * Sccsid @(#)color.c	1.3 (gritter) 8/9/05
comments.h: * Sccsid @(#)comments.h	1.5 (gritter) 8/23/05
dpost.c: * Sccsid @(#)dpost.c	1.63 (gritter) 9/8/05
