...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	1.40 (gritter) 8/23/05";
const char creator[] = "Heirloom Documentation Tools - dpost 1.40 (gritter) 8/23/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.33 (gritter) 8/23/05
...
gen.h: * Sccsid @(#)gen.h	1.7 (gritter) 8/23/05
