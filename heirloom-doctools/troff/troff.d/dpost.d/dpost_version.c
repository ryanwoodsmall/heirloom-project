...
#define	USED
#endif
static const char sccsid[] USED = "@(#)dpost.sl	4.2 (gritter) 9/16/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.2 (gritter) 9/16/05";
/* SLIST */
/*
...
dpost.c: * Sccsid @(#)dpost.c	1.80 (gritter) 9/13/05
