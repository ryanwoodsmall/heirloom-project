...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.55 (gritter) 8/9/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.55 (gritter) 8/9/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.55 (gritter) 8/9/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.55 (gritter) 8/9/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.55 (gritter) 8/9/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.55";
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.131 (gritter) 8/9/06
n4.c: * Sccsid @(#)n4.c	1.56 (gritter) 8/9/06
n5.c: * Sccsid @(#)n5.c	1.74 (gritter) 8/9/06
n7.c: * Sccsid @(#)n7.c	1.89 (gritter) 8/9/06
...
tdef.h: * Sccsid @(#)tdef.h	1.117 (gritter) 8/9/06
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.164 (gritter) 8/9/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.151 (gritter) 8/9/06
