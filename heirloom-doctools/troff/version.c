...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.2 (gritter) 11/9/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.2 (gritter) 11/9/06";
const char creator[] = "Heirloom Documentation Tools - dpost 8.2 (gritter) 11/9/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.2 (gritter) 11/9/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.2 (gritter) 11/9/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.2";
/* SLIST */
/*
