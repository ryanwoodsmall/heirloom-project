...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.17 (gritter) 9/20/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.17 (gritter) 9/20/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.41 (gritter) 9/18/05
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.30 (gritter) 9/20/05
troff.d/afm.h: * Sccsid @(#)afm.h	1.11 (gritter) 9/20/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.88 (gritter) 9/18/05
