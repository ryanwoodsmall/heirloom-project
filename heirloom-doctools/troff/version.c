...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.36 (gritter) 2/23/07";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.36 (gritter) 2/23/07";
const char creator[] = "Heirloom Documentation Tools - dpost 8.36 (gritter) 2/23/07";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.36 (gritter) 2/23/07";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.36 (gritter) 2/23/07";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.36";
/* SLIST */
/*
...
n9.c: * Sccsid @(#)n9.c	1.74 (gritter) 2/23/07
