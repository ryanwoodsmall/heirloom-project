...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.175 (gritter) 9/11/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.175 (gritter) 9/11/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.44 (gritter) 9/11/05
...
nroff.d/proto.h: * Sccsid @(#)proto.h	1.16 (gritter) 9/11/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.23 (gritter) 9/11/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.43 (gritter) 9/11/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.77 (gritter) 9/11/05
