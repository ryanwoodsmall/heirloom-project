...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.16 (gritter) 12/3/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.16 (gritter) 12/3/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.16 (gritter) 12/3/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.16 (gritter) 12/3/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.16 (gritter) 12/3/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.29 (gritter) 12/3/05
...
n1.c: * Sccsid @(#)n1.c	1.47 (gritter) 12/3/05
...
ni.c: * Sccsid @(#)ni.c	1.16 (gritter) 12/3/05
nii.c: * Sccsid @(#)nii.c	1.18 (gritter) 11/16/05
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.56 (gritter) 12/3/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.20 (gritter) 12/3/05
