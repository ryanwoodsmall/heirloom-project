...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.155 (gritter) 9/5/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.155 (gritter) 9/5/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.36 (gritter) 9/5/05
