...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.11 (gritter) 11/13/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.11 (gritter) 11/13/06";
const char creator[] = "Heirloom Documentation Tools - dpost 8.11 (gritter) 11/13/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.11 (gritter) 11/13/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.11 (gritter) 11/13/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.11";
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.158 (gritter) 11/13/06
