...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.54 (gritter) 4/19/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.54 (gritter) 4/19/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.54 (gritter) 4/19/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.54 (gritter) 4/19/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.54 (gritter) 4/19/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.54";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.42 (gritter) 4/18/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.73 (gritter) 4/18/06
n2.c: * Sccsid @(#)n2.c	1.19 (gritter) 4/18/06
n3.c: * Sccsid @(#)n3.c	1.84 (gritter) 4/18/06
n4.c: * Sccsid @(#)n4.c	1.25 (gritter) 3/21/06
n5.c: * Sccsid @(#)n5.c	1.41 (gritter) 4/18/06
n7.c: * Sccsid @(#)n7.c	1.45 (gritter) 4/2/06
n8.c: * Sccsid @(#)n8.c	1.23 (gritter) 4/19/06
n9.c: * Sccsid @(#)n9.c	1.41 (gritter) 4/14/06
ni.c: * Sccsid @(#)ni.c	1.21 (gritter) 4/18/06
nii.c: * Sccsid @(#)nii.c	1.29 (gritter) 4/18/06
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.76 (gritter) 4/18/06
nroff.d/n10.c: * Sccsid @(#)n10.c	1.23 (gritter) 3/22/06
nroff.d/n6.c: * Sccsid @(#)n6.c	1.33 (gritter) 4/14/06
nroff.d/proto.h: * Sccsid @(#)proto.h	1.34 (gritter) 4/14/06
nroff.d/tw.h: * Sccsid @(#)tw.h	1.5 (gritter) 9/8/05
troff.d/afm.c: * Sccsid @(#)afm.c	1.53 (gritter) 3/20/06
troff.d/afm.h: * Sccsid @(#)afm.h	1.29 (gritter) 4/14/06
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.53 (gritter) 4/19/06
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.15 (gritter) 3/16/06
troff.d/proto.h: * Sccsid @(#)proto.h	1.43 (gritter) 4/14/06
troff.d/t10.c: * Sccsid @(#)t10.c	1.67 (gritter) 4/14/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.139 (gritter) 4/19/06
troff.d/troff.h: * Sccsid @(#)troff.h	1.23 (gritter) 4/14/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.146 (gritter) 4/17/06
