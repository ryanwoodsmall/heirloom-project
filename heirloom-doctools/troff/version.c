...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.51 (gritter) 10/5/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  4.51 (gritter) 10/5/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.51 (gritter) 10/5/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.51 (gritter) 10/5/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.51 (gritter) 10/5/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.25 (gritter) 10/5/05
