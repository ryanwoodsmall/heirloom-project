...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.44 (gritter) 8/17/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.44 (gritter) 8/17/05";
#endif	/* !NROFF */
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.9 (gritter) 8/16/05
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
mapmalloc.c: *	Sccsid @(#)mapmalloc.c	1.4 (gritter) 2/20/05
n1.c: * Sccsid @(#)n1.c	1.17 (gritter) 8/16/05
...
tdef.h: * Sccsid @(#)tdef.h	1.17 (gritter) 8/16/05
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.3 (gritter) 8/17/05
troff.d/afm.h: * Sccsid @(#)afm.h	1.2 (gritter) 8/17/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.3 (gritter) 8/16/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.7 (gritter) 8/17/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.9 (gritter) 8/17/05
*/
