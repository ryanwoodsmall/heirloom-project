...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.56 (gritter) 4/19/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.56 (gritter) 4/19/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.56 (gritter) 4/19/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.56 (gritter) 4/19/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.56 (gritter) 4/19/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.56";
/* SLIST */
/*
...
n5.c: * Sccsid @(#)n5.c	1.42 (gritter) 4/19/06
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.68 (gritter) 4/19/06
