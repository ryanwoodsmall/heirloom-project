...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.34 (gritter) 3/26/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.34 (gritter) 3/26/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.34 (gritter) 3/26/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.34 (gritter) 3/26/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.34 (gritter) 3/26/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.34";
/* SLIST */
/*
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.131 (gritter) 3/26/06
