...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.51 (gritter) 8/18/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.51 (gritter) 8/18/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.16 (gritter) 8/16/05
...
nroff.d/n6.c: * Sccsid @(#)n6.c	1.6 (gritter) 8/16/05
nroff.d/proto.h: * Sccsid @(#)proto.h	1.3 (gritter) 8/16/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.4 (gritter) 8/17/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.11 (gritter) 8/18/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.16 (gritter) 8/18/05
