...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.17 (gritter) 11/14/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.17 (gritter) 11/14/06";
const char creator[] = "Heirloom Documentation Tools - dpost 8.17 (gritter) 11/14/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.17 (gritter) 11/14/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.17 (gritter) 11/14/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.17";
/* SLIST */
/*
...
n2.c: * Sccsid @(#)n2.c	1.42 (gritter) 11/14/06
...
tdef.h: * Sccsid @(#)tdef.h	1.156 (gritter) 11/13/06
