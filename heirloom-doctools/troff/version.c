...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.81 (gritter) 6/28/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.81 (gritter) 6/28/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.81 (gritter) 6/28/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.81 (gritter) 6/28/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.81 (gritter) 6/28/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.81";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.45 (gritter) 6/15/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.78 (gritter) 6/28/06
n2.c: * Sccsid @(#)n2.c	1.20 (gritter) 4/27/06
n3.c: * Sccsid @(#)n3.c	1.92 (gritter) 6/16/06
