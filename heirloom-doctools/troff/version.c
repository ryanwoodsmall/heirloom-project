...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.36 (gritter) 12/10/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.36 (gritter) 12/10/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.36 (gritter) 12/10/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.36 (gritter) 12/10/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.36 (gritter) 12/10/05";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.36";
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.61 (gritter) 12/6/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.102 (gritter) 12/6/05
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.111 (gritter) 12/10/05
