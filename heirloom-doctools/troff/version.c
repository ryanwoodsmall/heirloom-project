...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.81 (gritter) 8/24/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.81 (gritter) 8/24/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.81 (gritter) 8/24/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.81 (gritter) 8/24/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.81 (gritter) 8/24/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.81";
/* SLIST */
/*
...
n4.c: * Sccsid @(#)n4.c	1.67 (gritter) 8/24/06
n5.c: * Sccsid @(#)n5.c	1.88 (gritter) 8/24/06
n7.c: * Sccsid @(#)n7.c	1.98 (gritter) 8/24/06
