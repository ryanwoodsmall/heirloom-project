...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.2 (gritter) 7/16/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.2 (gritter) 7/16/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.2 (gritter) 7/16/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.2 (gritter) 7/16/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.2 (gritter) 7/16/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.2";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.54 (gritter) 7/16/06
...
n7.c: * Sccsid @(#)n7.c	1.73 (gritter) 7/16/06
