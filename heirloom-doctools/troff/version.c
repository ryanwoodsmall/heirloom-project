...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.56 (gritter) 8/4/07";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.56 (gritter) 8/4/07";
const char creator[] = "Heirloom Documentation Tools - dpost 8.56 (gritter) 8/4/07";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.56 (gritter) 8/4/07";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.56 (gritter) 8/4/07";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.56";
/* SLIST */
/*
...
n8.c: * Sccsid @(#)n8.c	1.42 (gritter) 8/4/07
