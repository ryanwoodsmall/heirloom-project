...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.28 (gritter) 9/30/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.28 (gritter) 9/30/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.28 (gritter) 9/30/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
