...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.29 (gritter) 10/1/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.29 (gritter) 10/1/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.29 (gritter) 10/1/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.9 (gritter) 9/30/05
