...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.57 (gritter) 10/13/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  4.57 (gritter) 10/13/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.57 (gritter) 10/13/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.57 (gritter) 10/13/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.57 (gritter) 10/13/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.27 (gritter) 9/30/05
...
n1.c: * Sccsid @(#)n1.c	1.42 (gritter) 9/27/05
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.26 (gritter) 10/8/05
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.9 (gritter) 10/11/05
troff.d/proto.h: * Sccsid @(#)proto.h	1.30 (gritter) 9/30/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.50 (gritter) 10/3/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.97 (gritter) 10/13/05
troff.d/troff.h: * Sccsid @(#)troff.h	1.13 (gritter) 9/11/05
troff.d/unimap.c: * Sccsid @(#)unimap.c	1.9 (gritter) 10/4/05
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.101 (gritter) 10/11/05
...
troff.d/dpost.d/dpost_draw.c: * Sccsid @(#)draw.c	1.3 (gritter) 8/9/05
troff.d/dpost.d/dpost_makedev.c: * Sccsid @(#)dpost_makedev.c	1.1 (gritter) 9/4/05
troff.d/dpost.d/dpost_otf.c: * Sccsid @(#)dpost_otf.c	1.2 (gritter) 9/29/05
...
troff.d/dpost.d/path.h: * Sccsid @(#)path.h	1.3 (gritter) 8/9/05
troff.d/dpost.d/pictures.c: * Sccsid @(#)pictures.c	1.4 (gritter) 9/9/05
troff.d/dpost.d/ps_include.c: * Sccsid @(#)ps_include.c	1.5 (gritter) 8/13/05
