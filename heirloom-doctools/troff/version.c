...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.6 (gritter) 3/3/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.6 (gritter) 3/3/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.6 (gritter) 3/3/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.6 (gritter) 3/3/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.6 (gritter) 3/3/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.6";
/* SLIST */
/*
...
n4.c: * Sccsid @(#)n4.c	1.24 (gritter) 3/3/06
n5.c: * Sccsid @(#)n5.c	1.38 (gritter) 3/3/06
n7.c: * Sccsid @(#)n7.c	1.43 (gritter) 2/19/06
n8.c: * Sccsid @(#)n8.c	1.19 (gritter) 2/19/06
n9.c: * Sccsid @(#)n9.c	1.38 (gritter) 3/3/06
...
nroff.d/n6.c: * Sccsid @(#)n6.c	1.29 (gritter) 3/3/06
nroff.d/proto.h: * Sccsid @(#)proto.h	1.30 (gritter) 3/3/06
nroff.d/tw.h: * Sccsid @(#)tw.h	1.5 (gritter) 9/8/05
troff.d/afm.c: * Sccsid @(#)afm.c	1.45 (gritter) 3/3/06
troff.d/afm.h: * Sccsid @(#)afm.h	1.25 (gritter) 3/3/06
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.40 (gritter) 3/3/06
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.11 (gritter) 12/20/05
troff.d/proto.h: * Sccsid @(#)proto.h	1.38 (gritter) 3/3/06
troff.d/t10.c: * Sccsid @(#)t10.c	1.63 (gritter) 2/13/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.124 (gritter) 3/3/06
