...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.39 (gritter) 10/2/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.39 (gritter) 10/2/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.39 (gritter) 10/2/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.19 (gritter) 10/2/05
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.4 (gritter) 10/2/05
troff.d/proto.h: * Sccsid @(#)proto.h	1.30 (gritter) 9/30/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.49 (gritter) 9/30/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.93 (gritter) 10/2/05
