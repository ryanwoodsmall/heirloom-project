...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.12 (gritter) 9/18/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.12 (gritter) 9/18/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.28 (gritter) 9/18/05
