...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.110 (gritter) 8/27/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.110 (gritter) 8/27/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
tdef.h: * Sccsid @(#)tdef.h	1.32 (gritter) 8/25/05
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.18 (gritter) 8/27/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.46 (gritter) 8/27/05
