...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.84 (gritter) 8/21/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.84 (gritter) 8/21/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.26 (gritter) 8/21/05
n4.c: * Sccsid @(#)n4.c	1.7 (gritter) 8/15/05
n5.c: * Sccsid @(#)n5.c	1.15 (gritter) 8/21/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.35 (gritter) 8/21/05
