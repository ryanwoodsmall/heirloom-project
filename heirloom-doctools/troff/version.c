...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.50 (gritter) 12/20/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.50 (gritter) 12/20/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.50 (gritter) 12/20/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.50 (gritter) 12/20/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.50 (gritter) 12/20/05";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.50";
/* SLIST */
/*
...
troff.d/afm.h: * Sccsid @(#)afm.h	1.18 (gritter) 12/20/05
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.35 (gritter) 12/20/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.110 (gritter) 12/20/05
