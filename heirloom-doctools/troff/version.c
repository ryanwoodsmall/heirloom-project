...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.156 (gritter) 9/5/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.156 (gritter) 9/5/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.24 (gritter) 9/5/05
...
tdef.h: * Sccsid @(#)tdef.h	1.38 (gritter) 9/5/05
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.37 (gritter) 9/5/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.71 (gritter) 9/5/05
