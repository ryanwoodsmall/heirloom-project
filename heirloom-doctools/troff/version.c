...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.41 (gritter) 10/3/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.41 (gritter) 10/3/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.41 (gritter) 10/3/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
