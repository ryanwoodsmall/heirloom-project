...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.154 (gritter) 9/5/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.154 (gritter) 9/5/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/makedev.c: * Sccsid @(#)makedev.c	1.9 (gritter) 9/5/05
