...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.40 (gritter) 12/14/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.40 (gritter) 12/14/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.40 (gritter) 12/14/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.40 (gritter) 12/14/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.40 (gritter) 12/14/05";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.40";
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.54 (gritter) 12/9/05
n2.c: * Sccsid @(#)n2.c	1.13 (gritter) 12/8/05
n3.c: * Sccsid @(#)n3.c	1.62 (gritter) 12/10/05
...
nroff.d/proto.h: * Sccsid @(#)proto.h	1.24 (gritter) 12/10/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.31 (gritter) 12/10/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.52 (gritter) 12/10/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.103 (gritter) 12/10/05
troff.d/troff.h: * Sccsid @(#)troff.h	1.14 (gritter) 12/10/05
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.112 (gritter) 12/10/05
