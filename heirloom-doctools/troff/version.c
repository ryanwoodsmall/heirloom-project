...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.75 (gritter) 8/20/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.75 (gritter) 8/20/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.23 (gritter) 8/20/05
n4.c: * Sccsid @(#)n4.c	1.7 (gritter) 8/15/05
n5.c: * Sccsid @(#)n5.c	1.12 (gritter) 8/20/05
...
tdef.h: * Sccsid @(#)tdef.h	1.23 (gritter) 8/20/05
