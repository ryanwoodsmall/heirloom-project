...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.182 (gritter) 9/13/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.182 (gritter) 9/13/05";
#endif	/* !NROFF */
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.25 (gritter) 9/11/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.26 (gritter) 9/11/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.46 (gritter) 9/11/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.82 (gritter) 9/11/05
