...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.36 (gritter) 10/2/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.36 (gritter) 10/2/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.36 (gritter) 10/2/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.16 (gritter) 10/2/05
