...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.135 (gritter) 9/2/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.135 (gritter) 9/2/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.31 (gritter) 9/2/05
