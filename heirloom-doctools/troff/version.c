...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.86 (gritter) 7/3/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.86 (gritter) 7/3/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.86 (gritter) 7/3/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.86 (gritter) 7/3/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.86 (gritter) 7/3/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.86";
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.60 (gritter) 7/3/06
