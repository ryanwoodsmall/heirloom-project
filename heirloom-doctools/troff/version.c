...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.70 (gritter) 8/20/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.70 (gritter) 8/20/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.21 (gritter) 8/20/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.10 (gritter) 8/20/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.16 (gritter) 8/20/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.30 (gritter) 8/20/05
