...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.7 (gritter) 7/18/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.7 (gritter) 7/18/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.7 (gritter) 7/18/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.7 (gritter) 7/18/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.7 (gritter) 7/18/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.7";
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.106 (gritter) 7/18/06
n4.c: * Sccsid @(#)n4.c	1.35 (gritter) 7/17/06
n5.c: * Sccsid @(#)n5.c	1.54 (gritter) 7/17/06
n7.c: * Sccsid @(#)n7.c	1.76 (gritter) 7/17/06
n8.c: * Sccsid @(#)n8.c	1.28 (gritter) 7/4/06
n9.c: * Sccsid @(#)n9.c	1.47 (gritter) 7/17/06
ni.c: * Sccsid @(#)ni.c	1.31 (gritter) 7/17/06
nii.c: * Sccsid @(#)nii.c	1.35 (gritter) 7/11/06
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.94 (gritter) 7/17/06
nroff.d/n10.c: * Sccsid @(#)n10.c	1.26 (gritter) 7/17/06
nroff.d/n6.c: * Sccsid @(#)n6.c	1.39 (gritter) 7/17/06
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.76 (gritter) 7/17/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.156 (gritter) 7/17/06
