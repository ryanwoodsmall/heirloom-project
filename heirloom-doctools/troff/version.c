...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.120 (gritter) 9/22/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.120 (gritter) 9/22/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.120 (gritter) 9/22/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.120 (gritter) 9/22/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.120 (gritter) 9/22/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.120";
/* SLIST */
/*
...
troff.d/dev.h: * Sccsid @(#)dev.h	1.14 (gritter) 9/22/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.162 (gritter) 9/22/06
