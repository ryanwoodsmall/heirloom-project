...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.60 (gritter) 8/11/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.60 (gritter) 8/11/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.60 (gritter) 8/11/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.60 (gritter) 8/11/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.60 (gritter) 8/11/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.60";
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.135 (gritter) 8/11/06
n4.c: * Sccsid @(#)n4.c	1.57 (gritter) 8/10/06
