...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.26 (gritter) 12/6/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.26 (gritter) 12/6/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.26 (gritter) 12/6/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.26 (gritter) 12/6/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.26 (gritter) 12/6/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.101 (gritter) 12/6/05
