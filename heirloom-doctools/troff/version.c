...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.131 (gritter) 8/30/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.131 (gritter) 8/30/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n5.c: * Sccsid @(#)n5.c	1.19 (gritter) 8/30/05
...
tdef.h: * Sccsid @(#)tdef.h	1.33 (gritter) 8/28/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.19 (gritter) 8/30/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.31 (gritter) 8/30/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.56 (gritter) 8/30/05
