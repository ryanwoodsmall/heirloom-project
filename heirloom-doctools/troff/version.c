...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.118 (gritter) 9/17/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.118 (gritter) 9/17/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.118 (gritter) 9/17/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.118 (gritter) 9/17/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.118 (gritter) 9/17/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.118";
/* SLIST */
/*
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.92 (gritter) 9/17/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.161 (gritter) 9/17/06
