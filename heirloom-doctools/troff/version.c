...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.88 (gritter) 9/2/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.88 (gritter) 9/2/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.88 (gritter) 9/2/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.88 (gritter) 9/2/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.88 (gritter) 9/2/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.88";
/* SLIST */
/*
...
n5.c: * Sccsid @(#)n5.c	1.89 (gritter) 8/31/06
...
tdef.h: * Sccsid @(#)tdef.h	1.129 (gritter) 8/31/06
