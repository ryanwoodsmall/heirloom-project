...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.80 (gritter) 8/24/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.80 (gritter) 8/24/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.80 (gritter) 8/24/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.80 (gritter) 8/24/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.80 (gritter) 8/24/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.80";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.81 (gritter) 8/24/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.115 (gritter) 8/24/06
n2.c: * Sccsid @(#)n2.c	1.28 (gritter) 8/9/06
n3.c: * Sccsid @(#)n3.c	1.144 (gritter) 8/24/06
n4.c: * Sccsid @(#)n4.c	1.66 (gritter) 8/24/06
n5.c: * Sccsid @(#)n5.c	1.87 (gritter) 8/24/06
n7.c: * Sccsid @(#)n7.c	1.97 (gritter) 8/24/06
n8.c: * Sccsid @(#)n8.c	1.33 (gritter) 8/6/06
n9.c: * Sccsid @(#)n9.c	1.62 (gritter) 8/13/06
ni.c: * Sccsid @(#)ni.c	1.39 (gritter) 8/24/06
nii.c: * Sccsid @(#)nii.c	1.42 (gritter) 8/12/06
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.127 (gritter) 8/24/06
