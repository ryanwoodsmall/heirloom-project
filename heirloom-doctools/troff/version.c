...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.50 (gritter) 10/4/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  4.50 (gritter) 10/4/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.50 (gritter) 10/4/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.50 (gritter) 10/4/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.50 (gritter) 10/4/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.24 (gritter) 10/4/05
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.7 (gritter) 10/3/05
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.99 (gritter) 10/3/05
