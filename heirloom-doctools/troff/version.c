...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.31 (gritter) 8/15/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.31 (gritter) 8/15/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.14 (gritter) 8/15/05
n2.c: * Sccsid @(#)n2.c	1.6 (gritter) 8/8/05
n3.c: * Sccsid @(#)n3.c	1.10 (gritter) 8/15/05
n4.c: * Sccsid @(#)n4.c	1.6 (gritter) 8/15/05
...
tdef.h: * Sccsid @(#)tdef.h	1.12 (gritter) 8/15/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.14 (gritter) 8/14/05
nroff.d/n6.c: * Sccsid @(#)n6.c	1.4 (gritter) 8/8/05
nroff.d/proto.h: * Sccsid @(#)version.c	1.31 (gritter) 8/15/05
...
troff.d/proto.h: * Sccsid @(#)version.c	1.31 (gritter) 8/15/05
