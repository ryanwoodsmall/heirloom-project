...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.11 (gritter) 7/29/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.11 (gritter) 7/29/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.11 (gritter) 7/29/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.11 (gritter) 7/29/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.11 (gritter) 7/29/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.11";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.57 (gritter) 7/23/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.86 (gritter) 7/29/06
...
tdef.h: * Sccsid @(#)tdef.h	1.97 (gritter) 7/29/06
