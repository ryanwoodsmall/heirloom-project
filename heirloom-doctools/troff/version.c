...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.130 (gritter) 8/29/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.130 (gritter) 8/29/05";
#endif	/* !NROFF */
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.17 (gritter) 8/28/05
...
n3.c: * Sccsid @(#)n3.c	1.37 (gritter) 8/29/05
n4.c: * Sccsid @(#)n4.c	1.8 (gritter) 8/23/05
n5.c: * Sccsid @(#)n5.c	1.18 (gritter) 8/28/05
...
nii.c: * Sccsid @(#)nii.c	1.10 (gritter) 8/28/05
...
nroff.d/n6.c: * Sccsid @(#)n6.c	1.16 (gritter) 8/29/05
nroff.d/proto.h: * Sccsid @(#)proto.h	1.12 (gritter) 8/29/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.18 (gritter) 8/29/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.30 (gritter) 8/29/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.55 (gritter) 8/29/05
troff.d/troff.h: * Sccsid @(#)troff.h	1.8 (gritter) 8/29/05
