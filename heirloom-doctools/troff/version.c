...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.76 (gritter) 1/23/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.76 (gritter) 1/23/06";
const char creator[] = "Heirloom Documentation Tools - dpost 5.76 (gritter) 1/23/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.76 (gritter) 1/23/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.76 (gritter) 1/23/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.76";
/* SLIST */
/*
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.118 (gritter) 1/20/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.130 (gritter) 1/23/06
