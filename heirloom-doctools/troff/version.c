...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.24 (gritter) 12/5/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.24 (gritter) 12/5/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.24 (gritter) 12/5/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.24 (gritter) 12/5/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.24 (gritter) 12/5/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.50 (gritter) 12/5/05
n2.c: * Sccsid @(#)n2.c	1.12 (gritter) 12/5/05
n3.c: * Sccsid @(#)n3.c	1.58 (gritter) 12/5/05
n4.c: * Sccsid @(#)n4.c	1.14 (gritter) 12/4/05
n5.c: * Sccsid @(#)n5.c	1.24 (gritter) 12/5/05
