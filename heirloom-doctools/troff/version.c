...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.50 (gritter) 8/18/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.50 (gritter) 8/18/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.5 (gritter) 8/17/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.15 (gritter) 8/18/05
troff.d/unimap.c: * Sccsid @(#)unimap.c	1.2 (gritter) 8/17/05
