...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.146 (gritter) 10/27/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.146 (gritter) 10/27/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.146 (gritter) 10/27/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.146 (gritter) 10/27/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.146 (gritter) 10/27/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.146";
/* SLIST */
/*
...
n5.c: * Sccsid @(#)n5.c	1.108 (gritter) 10/24/06
n7.c: * Sccsid @(#)n7.c	1.131 (gritter) 10/27/06
...
tdef.h: * Sccsid @(#)tdef.h	1.144 (gritter) 10/24/06
