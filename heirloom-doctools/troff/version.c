...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.40 (gritter) 8/16/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.40 (gritter) 8/16/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
tdef.h: * Sccsid @(#)tdef.h	1.16 (gritter) 8/16/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.16 (gritter) 8/16/05
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.5 (gritter) 8/16/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.6 (gritter) 8/16/05
*/
