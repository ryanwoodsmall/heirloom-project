...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.77 (gritter) 8/21/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.77 (gritter) 8/21/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n5.c: * Sccsid @(#)n5.c	1.14 (gritter) 8/21/05
