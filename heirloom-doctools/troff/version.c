...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.30 (gritter) 10/1/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.30 (gritter) 10/1/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.30 (gritter) 10/1/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.35 (gritter) 9/30/05
troff.d/afm.h: * Sccsid @(#)afm.h	1.15 (gritter) 9/30/05
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.10 (gritter) 10/1/05
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.2 (gritter) 10/1/05
troff.d/proto.h: * Sccsid @(#)proto.h	1.30 (gritter) 9/30/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.49 (gritter) 9/30/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.92 (gritter) 9/30/05
