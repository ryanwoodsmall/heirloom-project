...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.36 (gritter) 8/15/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.36 (gritter) 8/15/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.14 (gritter) 8/15/05
...
tdef.h: * Sccsid @(#)tdef.h	1.14 (gritter) 8/15/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.15 (gritter) 8/15/05
nroff.d/n6.c: * Sccsid @(#)n6.c	1.4 (gritter) 8/8/05
nroff.d/proto.h: * Sccsid @(#)version.c	1.36 (gritter) 8/15/05
...
troff.d/proto.h: * Sccsid @(#)version.c	1.36 (gritter) 8/15/05
