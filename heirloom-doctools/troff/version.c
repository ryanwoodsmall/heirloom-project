...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.23 (gritter) 3/16/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.23 (gritter) 3/16/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.23 (gritter) 3/16/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.23 (gritter) 3/16/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.23 (gritter) 3/16/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.23";
/* SLIST */
/*
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.50 (gritter) 3/15/06
troff.d/afm.h: * Sccsid @(#)afm.h	1.27 (gritter) 3/15/06
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.49 (gritter) 3/16/06
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.14 (gritter) 3/15/06
