...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.28 (gritter) 12/17/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.28 (gritter) 12/17/06";
const char creator[] = "Heirloom Documentation Tools - dpost 8.28 (gritter) 12/17/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.28 (gritter) 12/17/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.28 (gritter) 12/17/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.28";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.104 (gritter) 12/17/06
...
n7.c: * Sccsid @(#)n7.c	1.167 (gritter) 12/17/06
n8.c: * Sccsid @(#)n8.c	1.40 (gritter) 11/25/06
n9.c: * Sccsid @(#)n9.c	1.70 (gritter) 12/17/06
