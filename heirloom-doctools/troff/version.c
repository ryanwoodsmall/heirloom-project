...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.73 (gritter) 3/17/10";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.73 (gritter) 3/17/10";
const char creator[] = "Heirloom Documentation Tools - dpost 8.73 (gritter) 3/17/10";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.73 (gritter) 3/17/10";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.73 (gritter) 3/17/10";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.73";
/* SLIST */
/*
