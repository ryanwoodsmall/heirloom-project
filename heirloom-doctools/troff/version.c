...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.49 (gritter) 4/11/07";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.49 (gritter) 4/11/07";
const char creator[] = "Heirloom Documentation Tools - dpost 8.49 (gritter) 4/11/07";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.49 (gritter) 4/11/07";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.49 (gritter) 4/11/07";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.49";
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.175 (gritter) 4/11/07
n8.c: * Sccsid @(#)n8.c	1.41 (gritter) 4/11/07
...
tdef.h: * Sccsid @(#)tdef.h	1.162 (gritter) 4/11/07
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.63 (gritter) 3/15/07
