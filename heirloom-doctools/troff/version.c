...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.2 (gritter) 9/16/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.2 (gritter) 9/16/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.38 (gritter) 9/16/05
...
tdef.h: * Sccsid @(#)tdef.h	1.44 (gritter) 9/16/05
