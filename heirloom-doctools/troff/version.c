...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.20 (gritter) 11/16/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.20 (gritter) 11/16/06";
const char creator[] = "Heirloom Documentation Tools - dpost 8.20 (gritter) 11/16/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.20 (gritter) 11/16/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.20 (gritter) 11/16/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.20";
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.163 (gritter) 11/14/06
n8.c: * Sccsid @(#)n8.c	1.39 (gritter) 11/13/06
