...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.66 (gritter) 8/19/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.66 (gritter) 8/19/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.20 (gritter) 8/19/05
...
nroff.d/n6.c: * Sccsid @(#)n6.c	1.9 (gritter) 8/19/05
nroff.d/proto.h: * Sccsid @(#)proto.h	1.6 (gritter) 8/19/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.8 (gritter) 8/19/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.13 (gritter) 8/18/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.27 (gritter) 8/19/05
