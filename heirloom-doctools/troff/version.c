...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.69 (gritter) 8/12/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.69 (gritter) 8/12/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.69 (gritter) 8/12/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.69 (gritter) 8/12/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.69 (gritter) 8/12/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.69";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.77 (gritter) 8/12/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.112 (gritter) 8/12/06
n2.c: * Sccsid @(#)n2.c	1.28 (gritter) 8/9/06
n3.c: * Sccsid @(#)n3.c	1.140 (gritter) 8/12/06
