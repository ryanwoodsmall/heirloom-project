...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.42 (gritter) 8/7/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.42 (gritter) 8/7/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.42 (gritter) 8/7/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.42 (gritter) 8/7/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.42 (gritter) 8/7/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.42";
/* SLIST */
/*
...
n4.c: * Sccsid @(#)n4.c	1.48 (gritter) 8/7/06
