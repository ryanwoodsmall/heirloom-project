...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.10 (gritter) 11/12/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.10 (gritter) 11/12/06";
const char creator[] = "Heirloom Documentation Tools - dpost 8.10 (gritter) 11/12/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.10 (gritter) 11/12/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.10 (gritter) 11/12/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.10";
/* SLIST */
/*
...
n5.c: * Sccsid @(#)n5.c	1.119 (gritter) 11/10/06
n7.c: * Sccsid @(#)n7.c	1.157 (gritter) 11/12/06
