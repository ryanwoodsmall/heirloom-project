...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.77 (gritter) 1/24/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.77 (gritter) 1/24/06";
const char creator[] = "Heirloom Documentation Tools - dpost 5.77 (gritter) 1/24/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.77 (gritter) 1/24/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.77 (gritter) 1/24/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.77";
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.33 (gritter) 12/19/05
...
n1.c: * Sccsid @(#)n1.c	1.57 (gritter) 1/6/06
n2.c: * Sccsid @(#)n2.c	1.14 (gritter) 12/19/05
n3.c: * Sccsid @(#)n3.c	1.71 (gritter) 1/6/06
n4.c: * Sccsid @(#)n4.c	1.21 (gritter) 12/19/05
n5.c: * Sccsid @(#)n5.c	1.34 (gritter) 1/1/06
n7.c: * Sccsid @(#)n7.c	1.40 (gritter) 12/6/05
n8.c: * Sccsid @(#)n8.c	1.18 (gritter) 12/19/05
n9.c: * Sccsid @(#)n9.c	1.35 (gritter) 1/6/06
ni.c: * Sccsid @(#)ni.c	1.18 (gritter) 12/6/05
nii.c: * Sccsid @(#)nii.c	1.21 (gritter) 12/19/05
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.66 (gritter) 12/19/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.21 (gritter) 12/5/05
nroff.d/n6.c: * Sccsid @(#)n6.c	1.27 (gritter) 12/23/05
nroff.d/proto.h: * Sccsid @(#)proto.h	1.28 (gritter) 12/20/05
nroff.d/tw.h: * Sccsid @(#)tw.h	1.5 (gritter) 9/8/05
troff.d/afm.c: * Sccsid @(#)afm.c	1.42 (gritter) 1/24/06
troff.d/afm.h: * Sccsid @(#)afm.h	1.22 (gritter) 1/24/06
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.38 (gritter) 1/5/06
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.11 (gritter) 12/20/05
troff.d/proto.h: * Sccsid @(#)proto.h	1.35 (gritter) 12/20/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.61 (gritter) 1/24/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.119 (gritter) 1/24/06
troff.d/troff.h: * Sccsid @(#)troff.h	1.20 (gritter) 1/11/06
troff.d/unimap.c: * Sccsid @(#)unimap.c	1.12 (gritter) 1/19/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.131 (gritter) 1/24/06
...
troff.d/dpost.d/misc.c: * Sccsid @(#)misc.c	1.10 (gritter) 1/6/06
