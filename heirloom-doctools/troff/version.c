...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.165 (gritter) 10/31/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.165 (gritter) 10/31/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.165 (gritter) 10/31/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.165 (gritter) 10/31/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.165 (gritter) 10/31/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.165";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.99 (gritter) 10/31/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.128 (gritter) 10/21/06
n2.c: * Sccsid @(#)n2.c	1.35 (gritter) 10/22/06
n3.c: * Sccsid @(#)n3.c	1.173 (gritter) 10/31/06
n4.c: * Sccsid @(#)n4.c	1.87 (gritter) 10/29/06
n5.c: * Sccsid @(#)n5.c	1.113 (gritter) 10/31/06
n7.c: * Sccsid @(#)n7.c	1.145 (gritter) 10/31/06
...
tdef.h: * Sccsid @(#)tdef.h	1.150 (gritter) 10/31/06
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.187 (gritter) 10/31/06
