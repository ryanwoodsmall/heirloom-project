...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.71 (gritter) 5/6/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.71 (gritter) 5/6/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.71 (gritter) 5/6/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.71 (gritter) 5/6/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.71 (gritter) 5/6/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.71";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.43 (gritter) 4/26/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.77 (gritter) 5/6/06
n2.c: * Sccsid @(#)n2.c	1.20 (gritter) 4/27/06
n3.c: * Sccsid @(#)n3.c	1.88 (gritter) 5/6/06
n4.c: * Sccsid @(#)n4.c	1.27 (gritter) 5/6/06
n5.c: * Sccsid @(#)n5.c	1.43 (gritter) 5/6/06
...
tdef.h: * Sccsid @(#)tdef.h	1.81 (gritter) 5/6/06
nroff.d/n10.c: * Sccsid @(#)n10.c	1.23 (gritter) 3/22/06
nroff.d/n6.c: * Sccsid @(#)n6.c	1.34 (gritter) 5/6/06
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.145 (gritter) 5/6/06
