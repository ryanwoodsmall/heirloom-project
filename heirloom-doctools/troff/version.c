...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	4.64 (gritter) 10/16/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  4.64 (gritter) 10/16/05";
const char creator[] = "Heirloom Documentation Tools - dpost 4.64 (gritter) 10/16/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.64 (gritter) 10/16/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.64 (gritter) 10/16/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.43 (gritter) 10/14/05
...
tdef.h: * Sccsid @(#)tdef.h	1.50 (gritter) 10/14/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.98 (gritter) 10/14/05
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.104 (gritter) 10/16/05
