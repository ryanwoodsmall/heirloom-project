...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.16 (gritter) 3/13/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.16 (gritter) 3/13/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.16 (gritter) 3/13/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.16 (gritter) 3/13/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.16 (gritter) 3/13/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.16";
/* SLIST */
/*
...
nroff.d/n6.c: * Sccsid @(#)n6.c	1.30 (gritter) 3/13/06
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.125 (gritter) 3/13/06
