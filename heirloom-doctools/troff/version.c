...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.90 (gritter) 2/17/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.90 (gritter) 2/17/06";
const char creator[] = "Heirloom Documentation Tools - dpost 5.90 (gritter) 2/17/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.90 (gritter) 2/17/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.90 (gritter) 2/17/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.90";
/* SLIST */
/*
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.121 (gritter) 2/17/06
