...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.55 (gritter) 8/18/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.55 (gritter) 8/18/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.18 (gritter) 8/18/05
...
tdef.h: * Sccsid @(#)tdef.h	1.19 (gritter) 8/18/05
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.7 (gritter) 8/18/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.18 (gritter) 8/18/05
