...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.9 (gritter) 7/19/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.9 (gritter) 7/19/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.9 (gritter) 7/19/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.9 (gritter) 7/19/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.9 (gritter) 7/19/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.9";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.56 (gritter) 7/17/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.84 (gritter) 7/18/06
n2.c: * Sccsid @(#)n2.c	1.23 (gritter) 7/19/06
n3.c: * Sccsid @(#)n3.c	1.108 (gritter) 7/19/06
n4.c: * Sccsid @(#)n4.c	1.35 (gritter) 7/17/06
n5.c: * Sccsid @(#)n5.c	1.54 (gritter) 7/17/06
n7.c: * Sccsid @(#)n7.c	1.77 (gritter) 7/19/06
...
tdef.h: * Sccsid @(#)tdef.h	1.95 (gritter) 7/19/06
