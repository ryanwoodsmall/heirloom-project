...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.129 (gritter) 8/29/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.129 (gritter) 8/29/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.29 (gritter) 8/29/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.54 (gritter) 8/29/05
troff.d/troff.h: * Sccsid @(#)troff.h	1.7 (gritter) 8/29/05
