...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.23 (gritter) 12/5/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.23 (gritter) 12/5/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.23 (gritter) 12/5/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.23 (gritter) 12/5/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.23 (gritter) 12/5/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.31 (gritter) 12/5/05
...
nii.c: * Sccsid @(#)nii.c	1.19 (gritter) 12/5/05
