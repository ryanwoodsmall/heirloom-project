...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.68 (gritter) 1/14/10";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.68 (gritter) 1/14/10";
const char creator[] = "Heirloom Documentation Tools - dpost 8.68 (gritter) 1/14/10";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.68 (gritter) 1/14/10";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.68 (gritter) 1/14/10";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.68";
/* SLIST */
/*
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.66 (gritter) 1/14/10
