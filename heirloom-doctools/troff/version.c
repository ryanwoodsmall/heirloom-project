...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.116 (gritter) 9/17/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.116 (gritter) 9/17/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.116 (gritter) 9/17/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.116 (gritter) 9/17/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.116 (gritter) 9/17/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.116";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.91 (gritter) 9/11/06
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.91 (gritter) 9/11/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.179 (gritter) 9/11/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.160 (gritter) 9/17/06
troff.d/dpost.d/dpost.h: * Sccsid @(#)dpost.h	1.10 (gritter) 9/17/06
troff.d/dpost.d/draw.c: * Sccsid @(#)draw.c	1.5 (gritter) 11/28/05
troff.d/dpost.d/ext.h: * Sccsid @(#)ext.h	1.5 (gritter) 1/6/06
troff.d/dpost.d/gen.h: * Sccsid @(#)gen.h	1.15 (gritter) 9/11/06
