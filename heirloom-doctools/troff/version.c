...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.4 (gritter) 7/17/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.4 (gritter) 7/17/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.4 (gritter) 7/17/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.4 (gritter) 7/17/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.4 (gritter) 7/17/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.4";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.55 (gritter) 7/17/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.83 (gritter) 7/16/06
n2.c: * Sccsid @(#)n2.c	1.22 (gritter) 7/3/06
n3.c: * Sccsid @(#)n3.c	1.103 (gritter) 7/17/06
n4.c: * Sccsid @(#)n4.c	1.34 (gritter) 7/17/06
n5.c: * Sccsid @(#)n5.c	1.53 (gritter) 7/17/06
n7.c: * Sccsid @(#)n7.c	1.75 (gritter) 7/17/06
...
tdef.h: * Sccsid @(#)tdef.h	1.93 (gritter) 7/17/06
