...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.39 (gritter) 8/16/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.39 (gritter) 8/16/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.15 (gritter) 8/15/05
...
ni.c: * Sccsid @(#)ni.c	1.10 (gritter) 8/16/05
nii.c: * Sccsid @(#)nii.c	1.6 (gritter) 8/15/05
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.15 (gritter) 8/16/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.15 (gritter) 8/15/05
nroff.d/n6.c: * Sccsid @(#)n6.c	1.5 (gritter) 8/16/05
nroff.d/proto.h: * Sccsid @(#)proto.h	1.2 (gritter) 8/16/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.2 (gritter) 8/16/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.4 (gritter) 8/15/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.5 (gritter) 8/16/05
*/
