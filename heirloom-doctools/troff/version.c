...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.153 (gritter) 9/5/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.153 (gritter) 9/5/05";
#endif	/* !NROFF */
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.20 (gritter) 9/5/05
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.69 (gritter) 9/5/05
