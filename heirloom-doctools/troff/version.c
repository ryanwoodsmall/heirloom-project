...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.4 (gritter) 11/8/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.4 (gritter) 11/8/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.4 (gritter) 11/8/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.4 (gritter) 11/8/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.4 (gritter) 11/8/05";
#endif	/* !DUMP, !NROFF */
/* SLIST */
/*
...
nii.c: * Sccsid @(#)nii.c	1.17 (gritter) 11/8/05
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.53 (gritter) 11/8/05
