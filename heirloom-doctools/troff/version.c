...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.81 (gritter) 2/1/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.81 (gritter) 2/1/06";
const char creator[] = "Heirloom Documentation Tools - dpost 5.81 (gritter) 2/1/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.81 (gritter) 2/1/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.81 (gritter) 2/1/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.81";
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.34 (gritter) 1/31/06
...
n1.c: * Sccsid @(#)n1.c	1.58 (gritter) 1/31/06
n2.c: * Sccsid @(#)n2.c	1.14 (gritter) 12/19/05
n3.c: * Sccsid @(#)n3.c	1.72 (gritter) 1/31/06
n4.c: * Sccsid @(#)n4.c	1.21 (gritter) 12/19/05
n5.c: * Sccsid @(#)n5.c	1.35 (gritter) 1/31/06
n7.c: * Sccsid @(#)n7.c	1.41 (gritter) 1/31/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.134 (gritter) 2/1/06
