...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.68 (gritter) 8/19/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.68 (gritter) 8/19/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.14 (gritter) 8/19/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.28 (gritter) 8/19/05
