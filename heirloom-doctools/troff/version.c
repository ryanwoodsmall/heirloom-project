...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	8.72 (gritter) 2/14/10";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  8.72 (gritter) 2/14/10";
const char creator[] = "Heirloom Documentation Tools - dpost 8.72 (gritter) 2/14/10";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	8.72 (gritter) 2/14/10";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	8.72 (gritter) 2/14/10";
#endif	/* !DUMP, !NROFF */
const char revision[] = "8.72";
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.179 (gritter) 2/14/10
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.67 (gritter) 1/14/10
