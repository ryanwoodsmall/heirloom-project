...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.179 (gritter) 9/11/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.179 (gritter) 9/11/05";
#endif	/* !NROFF */
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.24 (gritter) 9/11/05
...
n3.c: * Sccsid @(#)n3.c	1.46 (gritter) 9/11/05
n4.c: * Sccsid @(#)n4.c	1.12 (gritter) 9/5/05
n5.c: * Sccsid @(#)n5.c	1.21 (gritter) 9/2/05
n7.c: * Sccsid @(#)n7.c	1.32 (gritter) 9/11/05
n8.c: * Sccsid @(#)n8.c	1.16 (gritter) 9/5/05
n9.c: * Sccsid @(#)n9.c	1.19 (gritter) 9/11/05
...
nroff.d/proto.h: * Sccsid @(#)proto.h	1.18 (gritter) 9/11/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.25 (gritter) 9/11/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.44 (gritter) 9/11/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.81 (gritter) 9/11/05
