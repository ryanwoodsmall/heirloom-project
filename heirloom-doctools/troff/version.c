...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.138 (gritter) 9/3/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.138 (gritter) 9/3/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n8.c: * Sccsid @(#)n8.c	1.13 (gritter) 9/3/05
