...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.181 (gritter) 9/11/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.181 (gritter) 9/11/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.33 (gritter) 9/11/05
