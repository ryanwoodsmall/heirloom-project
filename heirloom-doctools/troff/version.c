...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.52 (gritter) 8/18/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.52 (gritter) 8/18/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.18 (gritter) 8/17/05
n2.c: * Sccsid @(#)n2.c	1.6 (gritter) 8/8/05
n3.c: * Sccsid @(#)n3.c	1.17 (gritter) 8/18/05
...
n9.c: * Sccsid @(#)n9.c	1.9 (gritter) 8/17/05
ni.c: * Sccsid @(#)ni.c	1.11 (gritter) 8/16/05
nii.c: * Sccsid @(#)nii.c	1.6 (gritter) 8/15/05
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.18 (gritter) 8/17/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.17 (gritter) 8/16/05
nroff.d/n6.c: * Sccsid @(#)n6.c	1.7 (gritter) 8/18/05
nroff.d/proto.h: * Sccsid @(#)proto.h	1.4 (gritter) 8/18/05
nroff.d/tw.h: * Sccsid @(#)tw.h	1.4 (gritter) 8/8/05
troff.d/afm.c: * Sccsid @(#)afm.c	1.6 (gritter) 8/18/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.5 (gritter) 8/18/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.12 (gritter) 8/18/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.17 (gritter) 8/18/05
troff.d/troff.h: * Sccsid @(#)troff.h	1.1 (gritter) 8/18/05
troff.d/unimap.c: * Sccsid @(#)unimap.c	1.5 (gritter) 8/18/05
