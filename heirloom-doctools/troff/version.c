...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.14 (gritter) 7/30/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.14 (gritter) 7/30/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.14 (gritter) 7/30/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.14 (gritter) 7/30/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.14 (gritter) 7/30/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.14";
/* SLIST */
/*
...
n4.c: * Sccsid @(#)n4.c	1.37 (gritter) 7/29/06
n5.c: * Sccsid @(#)n5.c	1.62 (gritter) 7/29/06
...
tdef.h: * Sccsid @(#)tdef.h	1.101 (gritter) 7/29/06
