...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.153 (gritter) 10/28/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.153 (gritter) 10/28/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.153 (gritter) 10/28/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.153 (gritter) 10/28/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.153 (gritter) 10/28/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.153";
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.170 (gritter) 10/28/06
n4.c: * Sccsid @(#)n4.c	1.84 (gritter) 10/21/06
n5.c: * Sccsid @(#)n5.c	1.109 (gritter) 10/27/06
n7.c: * Sccsid @(#)n7.c	1.136 (gritter) 10/28/06
n8.c: * Sccsid @(#)n8.c	1.36 (gritter) 10/28/06
...
tdef.h: * Sccsid @(#)tdef.h	1.146 (gritter) 10/28/06
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.186 (gritter) 10/24/06
