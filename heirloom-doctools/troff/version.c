...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.107 (gritter) 8/26/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.107 (gritter) 8/26/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n8.c: * Sccsid @(#)n8.c	1.10 (gritter) 8/26/05
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.15 (gritter) 8/26/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.25 (gritter) 8/25/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.44 (gritter) 8/26/05
