...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.53 (gritter) 4/18/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.53 (gritter) 4/18/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.53 (gritter) 4/18/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.53 (gritter) 4/18/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.53 (gritter) 4/18/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.53";
/* SLIST */
/*
...
n8.c: * Sccsid @(#)n8.c	1.22 (gritter) 4/3/06
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.138 (gritter) 4/18/06
