...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.151 (gritter) 9/5/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.151 (gritter) 9/5/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.42 (gritter) 9/5/05
...
nroff.d/n6.c: * Sccsid @(#)n6.c	1.18 (gritter) 9/5/05
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.35 (gritter) 9/5/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.67 (gritter) 9/5/05
