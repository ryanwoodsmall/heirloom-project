...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.41 (gritter) 4/8/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.41 (gritter) 4/8/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.41 (gritter) 4/8/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.41 (gritter) 4/8/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.41 (gritter) 4/8/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.41";
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.77 (gritter) 4/8/06
...
nroff.d/proto.h: * Sccsid @(#)proto.h	1.32 (gritter) 4/8/06
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.41 (gritter) 4/8/06
troff.d/t10.c: * Sccsid @(#)t10.c	1.65 (gritter) 4/2/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.135 (gritter) 4/8/06
