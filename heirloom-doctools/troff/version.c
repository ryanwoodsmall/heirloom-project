...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.42 (gritter) 4/14/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.42 (gritter) 4/14/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.42 (gritter) 4/14/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.42 (gritter) 4/14/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.42 (gritter) 4/14/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.42";
/* SLIST */
/*
calloc.c: * Sccsid @(#)calloc.c	1.3 (gritter) 8/26/05
ext.h: * Sccsid @(#)ext.h	1.39 (gritter) 4/3/06
...
n1.c: * Sccsid @(#)n1.c	1.67 (gritter) 4/3/06
n2.c: * Sccsid @(#)n2.c	1.17 (gritter) 4/3/06
n3.c: * Sccsid @(#)n3.c	1.78 (gritter) 4/14/06
...
n9.c: * Sccsid @(#)n9.c	1.40 (gritter) 4/2/06
ni.c: * Sccsid @(#)ni.c	1.20 (gritter) 3/3/06
nii.c: * Sccsid @(#)nii.c	1.26 (gritter) 4/3/06
suftab.c: * Sccsid @(#)suftab.c	1.4 (gritter) 8/16/05
tdef.h: * Sccsid @(#)tdef.h	1.72 (gritter) 4/3/06
nroff.d/n10.c: * Sccsid @(#)n10.c	1.23 (gritter) 3/22/06
nroff.d/n6.c: * Sccsid @(#)n6.c	1.32 (gritter) 3/26/06
nroff.d/proto.h: * Sccsid @(#)proto.h	1.33 (gritter) 4/14/06
...
troff.d/proto.h: * Sccsid @(#)proto.h	1.42 (gritter) 4/14/06
troff.d/t10.c: * Sccsid @(#)t10.c	1.65 (gritter) 4/2/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.136 (gritter) 4/14/06
troff.d/troff.h: * Sccsid @(#)troff.h	1.22 (gritter) 4/2/06
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.142 (gritter) 4/4/06
