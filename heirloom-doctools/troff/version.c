...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.37 (gritter) 12/10/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.37 (gritter) 12/10/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.37 (gritter) 12/10/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.37 (gritter) 12/10/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.37 (gritter) 12/10/05";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.37";
/* SLIST */
/*
...
n5.c: * Sccsid @(#)n5.c	1.27 (gritter) 12/6/05
