...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.166 (gritter) 9/8/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.166 (gritter) 9/8/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.34 (gritter) 9/6/05
...
tdef.h: * Sccsid @(#)tdef.h	1.40 (gritter) 9/6/05
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.40 (gritter) 9/8/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.75 (gritter) 9/7/05
