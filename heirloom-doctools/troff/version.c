...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	6.21 (gritter) 3/14/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  6.21 (gritter) 3/14/06";
const char creator[] = "Heirloom Documentation Tools - dpost 6.21 (gritter) 3/14/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	6.21 (gritter) 3/14/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	6.21 (gritter) 3/14/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "6.21";
/* SLIST */
/*
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.49 (gritter) 3/14/06
troff.d/afm.h: * Sccsid @(#)afm.h	1.26 (gritter) 3/14/06
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.47 (gritter) 3/14/06
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.13 (gritter) 3/14/06
troff.d/proto.h: * Sccsid @(#)proto.h	1.39 (gritter) 3/13/06
troff.d/t10.c: * Sccsid @(#)t10.c	1.64 (gritter) 3/13/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.129 (gritter) 3/14/06
