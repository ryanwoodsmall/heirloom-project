...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	7.103 (gritter) 9/10/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  7.103 (gritter) 9/10/06";
const char creator[] = "Heirloom Documentation Tools - dpost 7.103 (gritter) 9/10/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	7.103 (gritter) 9/10/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	7.103 (gritter) 9/10/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "7.103";
/* SLIST */
/*
ext.h: * Sccsid @(#)ext.h	1.87 (gritter) 9/9/06
hytab.c: * Sccsid @(#)hytab.c	1.4 (gritter) 8/16/05
n1.c: * Sccsid @(#)n1.c	1.122 (gritter) 9/10/06
