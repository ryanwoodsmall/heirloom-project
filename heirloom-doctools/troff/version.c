...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.19 (gritter) 9/28/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.19 (gritter) 9/28/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.32 (gritter) 9/28/05
troff.d/afm.h: * Sccsid @(#)afm.h	1.12 (gritter) 9/27/05
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.2 (gritter) 9/28/05
