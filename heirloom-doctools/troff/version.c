...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.38 (gritter) 8/16/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.38 (gritter) 8/16/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n1.c: * Sccsid @(#)n1.c	1.16 (gritter) 8/15/05
...
nroff.d/proto.h: * Sccsid @(#)version.c	1.38 (gritter) 8/16/05
...
troff.d/proto.h: * Sccsid @(#)version.c	1.38 (gritter) 8/16/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.4 (gritter) 8/15/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.4 (gritter) 8/15/05
*/
