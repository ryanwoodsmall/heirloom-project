...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.63 (gritter) 1/2/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.63 (gritter) 1/2/06";
const char creator[] = "Heirloom Documentation Tools - dpost 5.63 (gritter) 1/2/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.63 (gritter) 1/2/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.63 (gritter) 1/2/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.63";
/* SLIST */
/*
