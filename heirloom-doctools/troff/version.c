...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.37 (gritter) 8/15/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.37 (gritter) 8/15/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
nroff.d/proto.h: * Sccsid @(#)version.c	1.37 (gritter) 8/15/05
...
troff.d/proto.h: * Sccsid @(#)version.c	1.37 (gritter) 8/15/05
