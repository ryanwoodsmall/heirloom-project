...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.7 (gritter) 9/17/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.7 (gritter) 9/17/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/t6.c: * Sccsid @(#)t6.c	1.84 (gritter) 9/17/05
