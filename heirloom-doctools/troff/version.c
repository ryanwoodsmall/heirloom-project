...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.73 (gritter) 1/14/06";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.73 (gritter) 1/14/06";
const char creator[] = "Heirloom Documentation Tools - dpost 5.73 (gritter) 1/14/06";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.73 (gritter) 1/14/06";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.73 (gritter) 1/14/06";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.73";
/* SLIST */
/*
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.41 (gritter) 1/1/06
troff.d/afm.h: * Sccsid @(#)afm.h	1.21 (gritter) 1/1/06
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.60 (gritter) 1/11/06
troff.d/t6.c: * Sccsid @(#)t6.c	1.117 (gritter) 1/11/06
troff.d/troff.h: * Sccsid @(#)troff.h	1.20 (gritter) 1/11/06
troff.d/unimap.c: * Sccsid @(#)unimap.c	1.11 (gritter) 12/22/05
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.129 (gritter) 1/14/06
