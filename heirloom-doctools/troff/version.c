...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.121 (gritter) 8/28/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.121 (gritter) 8/28/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n7.c: * Sccsid @(#)n7.c	1.20 (gritter) 8/28/05
