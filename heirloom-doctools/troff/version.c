...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.32 (gritter) 8/15/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.32 (gritter) 8/15/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.11 (gritter) 8/15/05
...
nroff.d/proto.h: * Sccsid @(#)version.c	1.32 (gritter) 8/15/05
...
troff.d/proto.h: * Sccsid @(#)version.c	1.32 (gritter) 8/15/05
