...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	4.23 (gritter) 9/30/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	4.23 (gritter) 9/30/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.49 (gritter) 9/30/05
...
tdef.h: * Sccsid @(#)tdef.h	1.48 (gritter) 9/30/05
nroff.d/n10.c: * Sccsid @(#)n10.c	1.19 (gritter) 9/11/05
nroff.d/n6.c: * Sccsid @(#)n6.c	1.21 (gritter) 9/18/05
nroff.d/proto.h: * Sccsid @(#)proto.h	1.22 (gritter) 9/30/05
nroff.d/tw.h: * Sccsid @(#)tw.h	1.5 (gritter) 9/8/05
troff.d/afm.c: * Sccsid @(#)afm.c	1.33 (gritter) 9/29/05
troff.d/afm.h: * Sccsid @(#)afm.h	1.13 (gritter) 9/29/05
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.5 (gritter) 9/29/05
troff.d/proto.h: * Sccsid @(#)proto.h	1.29 (gritter) 9/30/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.49 (gritter) 9/30/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.91 (gritter) 9/30/05
