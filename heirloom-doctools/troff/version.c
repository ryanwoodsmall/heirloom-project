...
#endif
#ifdef	NROFF
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	1.94 (gritter) 8/23/05";
#else	/* !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	1.94 (gritter) 8/23/05";
#endif	/* !NROFF */
/* SLIST */
/*
...
troff.d/t10.c: * Sccsid @(#)t10.c	1.22 (gritter) 8/23/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.40 (gritter) 8/23/05
troff.d/troff.h: * Sccsid @(#)troff.h	1.5 (gritter) 8/23/05
