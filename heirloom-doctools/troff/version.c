...
static const char sccsid[] USED =
	"@(#)/usr/ucb/otfdump.sl	5.56 (gritter) 12/23/05";
#elif defined (DPOST)
static const char sccsid[] USED = "@(#)dpost.sl  5.56 (gritter) 12/23/05";
const char creator[] = "Heirloom Documentation Tools - dpost 5.56 (gritter) 12/23/05";
#elif defined (NROFF)
static const char sccsid[] USED = "@(#)/usr/ucb/nroff.sl	5.56 (gritter) 12/23/05";
#else	/* !DUMP, !NROFF */
static const char sccsid[] USED = "@(#)/usr/ucb/troff.sl	5.56 (gritter) 12/23/05";
#endif	/* !DUMP, !NROFF */
const char revision[] = "5.56";
/* SLIST */
/*
...
n3.c: * Sccsid @(#)n3.c	1.69 (gritter) 12/20/05
n4.c: * Sccsid @(#)n4.c	1.21 (gritter) 12/19/05
n5.c: * Sccsid @(#)n5.c	1.30 (gritter) 12/19/05
...
troff.d/afm.c: * Sccsid @(#)afm.c	1.40 (gritter) 12/20/05
troff.d/afm.h: * Sccsid @(#)afm.h	1.20 (gritter) 12/22/05
...
troff.d/otf.c: * Sccsid @(#)otf.c	1.37 (gritter) 12/22/05
troff.d/otfdump.c: * Sccsid @(#)otfdump.c	1.11 (gritter) 12/20/05
troff.d/proto.h: * Sccsid @(#)proto.h	1.35 (gritter) 12/20/05
troff.d/t10.c: * Sccsid @(#)t10.c	1.58 (gritter) 12/22/05
troff.d/t6.c: * Sccsid @(#)t6.c	1.114 (gritter) 12/23/05
...
troff.d/dpost.d/dpost.c: * Sccsid @(#)dpost.c	1.121 (gritter) 12/22/05
