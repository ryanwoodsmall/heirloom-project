...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucblib/pm.sl	1.3 (gritter) 10/31/05";
/* SLIST */
/*
...
slug.h:	Sccsid @(#)slug.h	1.4 (gritter) 10/31/05	
...
slug.cc:	Sccsid @(#)slug.cc	1.5 (gritter) 10/31/05	
*/
