...
#endif
#ifdef	NEQN
static const char sccsid[] USED = "@(#)/usr/ucb/neqn.sl	5.5 (gritter) 9/11/06";
#else
static const char sccsid[] USED = "@(#)/usr/ucb/eqn.sl	5.5 (gritter) 9/11/06";
#endif
/* SLIST */
/*
diacrit.c: * Sccsid @(#)diacrit.c	1.4 (gritter) 10/29/05
e.h: * Sccsid @(#)e.h	1.8 (gritter) 11/6/05
e.y: * Sccsid @(#)e.y	1.5 (gritter) 8/13/05
eqnbox.c: * Sccsid @(#)eqnbox.c	1.5 (gritter) 11/6/05
...
io.c: * Sccsid @(#)io.c	1.10 (gritter) 9/11/06
