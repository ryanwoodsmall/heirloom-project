...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/tbl.sl	4.2 (gritter) 10/15/05";
/* SLIST */
/*
t..c: * Sccsid @(#)t..c	1.10 (gritter) 10/15/05
...
t6.c: * Sccsid @(#)t6.c	1.5 (gritter) 10/15/05
t7.c: * Sccsid @(#)t7.c	1.3 (gritter) 7/23/05
t8.c: * Sccsid @(#)t8.c	1.6 (gritter) 10/15/05
t9.c: * Sccsid @(#)t9.c	1.6 (gritter) 10/15/05
tb.c: * Sccsid @(#)tb.c	1.5 (gritter) 8/12/05
tc.c: * Sccsid @(#)tc.c	1.5 (gritter) 10/15/05
te.c: * Sccsid @(#)te.c	1.10 (gritter) 9/5/05
tf.c: * Sccsid @(#)tf.c	1.4 (gritter) 10/15/05
