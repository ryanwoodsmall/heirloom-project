...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/tbl.sl	5.12 (gritter) 9/8/06";
/* SLIST */
/*
t..c: * Sccsid @(#)t..c	1.14 (gritter) 9/8/06
t0.c: * Sccsid @(#)t0.c	1.8 (gritter) 9/8/06
...
t8.c: * Sccsid @(#)t8.c	1.9 (gritter) 9/8/06
