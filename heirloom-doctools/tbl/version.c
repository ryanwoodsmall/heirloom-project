...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/tbl.sl	5.13 (gritter) 9/8/06";
/* SLIST */
/*
t..c: * Sccsid @(#)t..c	1.16 (gritter) 9/8/06
t0.c: * Sccsid @(#)t0.c	1.10 (gritter) 9/8/06
t1.c: * Sccsid @(#)t1.c	1.11 (gritter) 2/26/06
t2.c: * Sccsid @(#)t2.c	1.3 (gritter) 7/23/05
t3.c: * Sccsid @(#)t3.c	1.9 (gritter) 9/8/06
