...
#define	USED
#endif
static const char sccsid[] USED = "@(#)/usr/ucb/tbl.sl	5.14 (gritter) 9/8/06";
/* SLIST */
/*
t..c: * Sccsid @(#)t..c	1.17 (gritter) 9/8/06
...
t7.c: * Sccsid @(#)t7.c	1.5 (gritter) 9/8/06
t8.c: * Sccsid @(#)t8.c	1.10 (gritter) 9/8/06
