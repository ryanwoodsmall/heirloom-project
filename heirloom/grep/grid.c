...
#define	USED
#endif
static const char sccsid[] USED = "@(#)grep.sl	2.37 (gritter) 12/12/04";
/*
ac.c:
...
egrep.y:
	egrep.sl	2.20 (gritter) 12/5/04
fgrep.c:
	fgrep.c	1.11 (gritter) 12/5/04
ggrep.c:
	ggrep.c	1.24 (gritter) 12/8/04
grep.c:
	grep.c	1.47 (gritter) 12/12/04
grep.h:
