...
sus.o: sus.c
	$(CC) $(CFLAGSS) $(CPPFLAGS) $(IWCHAR) $(ICOMMON) $(IUXRE) $(LARGEF) -c sus.c
...
clean:
	rm -f config.h fgrep egrep grep grep_sus ac.o alloc.o egrep.o fgrep.o ggrep.o grep.o grid.o plist.o rcomp.o sus.o svid3.o egrep.c core log *~
