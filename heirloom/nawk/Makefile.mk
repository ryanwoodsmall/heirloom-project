...
OBJ = awk.g.o awk.lx.o b.o lib.o main.o parse.o proctab.o run.o tran.o

awk: $(OBJ) version.o
	$(LD) $(LDFLAGS) $(OBJ) version.o $(LUXRE) -lm $(LCOMMON) $(LWCHAR) $(LIBS) -o awk

awk_sus: $(OBJ) version_sus.o
	$(LD) $(LDFLAGS) $(OBJ) version_sus.o $(LUXRE) -lm $(LCOMMON) $(LWCHAR) $(LIBS) -o awk_sus
...
clean:
	rm -f awk.g.o awk.lx.o b.o lib.o main.o parse.o proctab.o run.o \
