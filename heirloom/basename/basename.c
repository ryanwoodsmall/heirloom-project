...
#endif
#if defined (SUS)
static const char sccsid[] USED = "@(#)basename_sus.sl	1.8 (gritter) 5/1/04";
#elif defined (UCB)
static const char sccsid[] USED = "@(#)/usr/ucb/basename.sl	1.8 (gritter) 5/1/04";
#else
static const char sccsid[] USED = "@(#)basename.sl	1.8 (gritter) 5/1/04";
#endif
