 ...
 *
 * Sccsid @(#)maid.c	1.23 (gritter) 6/22/05
 */
/*
ma_id() {
...
#define	USED
#endif
static const char id[] = "@(#)ma.sl 1.23 (gritter) 6/22/05";
/* SLIST */
/*
...
getdomain.c: * Sccsid @(#)getdomain.c	1.4 (gritter) 6/22/05
...
main.c: * Sccsid @(#)main.c	1.10 (gritter) 6/22/05
...
sendmail.c: * Sccsid @(#)sendmail.c	1.6 (gritter) 6/22/05
...
xgetenv.c: * Sccsid @(#)xgetenv.c	1.4 (gritter) 6/22/05
*/
