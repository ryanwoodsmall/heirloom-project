 ...
 *
 * Sccsid @(#)maid.c	1.11 (gritter) 6/18/05
 */
/*
ma_id() {
...
#define	USED
#endif
static const char id[] = "@(#)ma.sl 1.11 (gritter) 6/18/05";
/* SLIST */
/*
Dout.c: * Sccsid @(#)Dout.c	1.4 (gritter) 6/18/05
Tout.c: * Sccsid @(#)Tout.c	1.4 (gritter) 6/18/05
add_recip.c: * Sccsid @(#)add_recip.c	1.4 (gritter) 6/18/05
casncmp.c: * Sccsid @(#)casncmp.c	1.3 (gritter) 6/18/05
cat.c: * Sccsid @(#)cat.c	1.4 (gritter) 6/18/05
ckdlivopts.c: * Sccsid @(#)ckdlivopts.c	1.4 (gritter) 6/18/05
cksaved.c: * Sccsid @(#)cksaved.c	1.5 (gritter) 6/18/05
...
fgetline.c: * Sccsid @(#)maid.c	1.11 (gritter) 6/18/05
...
gethead.c: * Sccsid @(#)gethead.c	1.4 (gritter) 6/18/05
...
islocal.c: * Sccsid @(#)islocal.c	1.3 (gritter) 6/18/05
istext.c: * Sccsid @(#)istext.c	1.4 (gritter) 6/18/05
...
main.c: * Sccsid @(#)main.c	1.7 (gritter) 6/18/05
...
sendlist.c: * Sccsid @(#)sendlist.c	1.7 (gritter) 6/18/05
...
xgetenv.c: * Sccsid @(#)xgetenv.c	1.3 (gritter) 6/18/05
*/
