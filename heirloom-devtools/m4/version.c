...
#endif
#ifdef	XPG4
static const char sccsid[] USED = "@(#)m4_xpg4.sl	2.4 (gritter) 11/27/05";
#else
static const char sccsid[] USED = "@(#)m4.sl	2.4 (gritter) 11/27/05";
#endif
/* SLIST */
/*
...
m4y.c: * Sccsid @(#)version.c	2.4 (gritter) 11/27/05
m4y.c: * Sccsid @(#)yaccpar	1.5 (gritter) 11/26/05
m4y.y: * Sccsid @(#)m4y.y	1.5 (gritter) 11/27/05
m4y_xpg4.c: * Sccsid @(#)version.c	2.4 (gritter) 11/27/05
