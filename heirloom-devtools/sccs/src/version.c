static const char id[] = "@(#)sccs.sl	1.4 (gritter) 12/20/06";
/* SLIST */
/*
admin.c: * Sccsid @(#)admin.c	1.3 (gritter) 12/20/06
comb.c: * Sccsid @(#)comb.c	1.3 (gritter) 12/20/06
delta.c: * Sccsid @(#)delta.c	1.4 (gritter) 12/20/06
get.c: * Sccsid @(#)get.c	1.5 (gritter) 12/20/06
help.c: * Sccsid @(#)help.c	1.3 (gritter) 12/20/06
prs.c: * Sccsid @(#)prs.c	1.3 (gritter) 12/20/06
prt.c: * Sccsid @(#)prt.c	1.3 (gritter) 12/20/06
rmchg.c: * Sccsid @(#)rmchg.c	1.3 (gritter) 12/20/06
sccs.c: * Sccsid @(#)sccs.c	1.3 (gritter) 12/20/06
unget.c: * Sccsid @(#)unget.c	1.3 (gritter) 12/20/06
val.c: * Sccsid @(#)val.c	1.3 (gritter) 12/20/06
...
../cassi/filehand.c: * Sccsid @(#)filehand.c	1.4 (gritter) 12/20/06
...
../comobj/dodelt.c: * Sccsid @(#)dodelt.c	1.4 (gritter) 12/20/06
../comobj/dofile.c: * Sccsid @(#)dofile.c	1.4 (gritter) 12/20/06
../comobj/dohist.c: * Sccsid @(#)dohist.c	1.4 (gritter) 12/20/06
../comobj/doie.c: * Sccsid @(#)doie.c	1.4 (gritter) 12/20/06
../comobj/dolist.c: * Sccsid @(#)dolist.c	1.4 (gritter) 12/20/06
...
../comobj/newstats.c: * Sccsid @(#)newstats.c	1.4 (gritter) 12/20/06
../comobj/permiss.c: * Sccsid @(#)permiss.c	1.4 (gritter) 12/20/06
...
../hdr/defines.h: * Sccsid @(#)defines.h	1.4 (gritter) 12/20/06
../hdr/fatal.h: * Sccsid @(#)fatal.h	1.3 (gritter) 12/20/06
...
../mpwlib/fatal.c: * Sccsid @(#)fatal.c	1.3 (gritter) 12/20/06
...
../mpwlib/lockit.c: * Sccsid @(#)lockit.c	1.4 (gritter) 12/20/06
...
../mpwlib/setsig.c: * Sccsid @(#)setsig.c	1.3 (gritter) 12/20/06
