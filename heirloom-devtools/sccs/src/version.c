static const char id[] = "@(#)sccs.sl	1.8 (gritter) 12/25/06";
/* SLIST */
/*
...
sccs.c: * Sccsid @(#)sccs.c	1.4 (gritter) 12/25/06
unget.c: * Sccsid @(#)unget.c	1.4 (gritter) 12/25/06
val.c: * Sccsid @(#)val.c	1.4 (gritter) 12/25/06
