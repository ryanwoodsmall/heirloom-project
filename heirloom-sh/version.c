...
#define	USED
#endif
static const char id[] USED = "@(#)sh.sl	1.17 (gritter) 6/16/05";
/* SLIST */
/*
...
defs.h: * Sccsid @(#)defs.h	1.13 (gritter) 6/16/05
...
msg.c: * Sccsid @(#)msg.c	1.8 (gritter) 6/16/05
name.c: * Sccsid @(#)name.c	1.11 (gritter) 6/16/05
