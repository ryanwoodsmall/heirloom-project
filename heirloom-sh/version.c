...
#define	USED
#endif
static const char id[] USED = "@(#)sh.sl	1.11 (gritter) 6/15/05";
/* SLIST */
/*
...
defs.h: * Sccsid @(#)defs.h	1.10 (gritter) 6/15/05
...
macro.c: * Sccsid @(#)macro.c	1.7 (gritter) 6/15/05
...
service.c: * Sccsid @(#)service.c	1.6 (gritter) 6/15/05
