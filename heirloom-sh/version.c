...
#define	USED
#endif
static const char id[] USED = "@(#)sh.sl	1.12 (gritter) 6/16/05";
/* SLIST */
/*
...
defs.h: * Sccsid @(#)defs.h	1.11 (gritter) 6/16/05
dup.h: * Sccsid @(#)dup.h	1.4 (gritter) 6/15/05
echo.c: * Sccsid @(#)echo.c	1.6 (gritter) 6/16/05
...
name.c: * Sccsid @(#)name.c	1.9 (gritter) 6/16/05
name.h: * Sccsid @(#)name.h	1.4 (gritter) 6/15/05
print.c: * Sccsid @(#)print.c	1.8 (gritter) 6/16/05
...
word.c: * Sccsid @(#)word.c	1.5 (gritter) 6/16/05
